...
// url = `https://v6.exchangerate-api.com/v6/2cae938db760a997f8f84387/latest/USD`;
...
//     myStr+=`         <tr>
//             <td>${key}</td>
//             <td>${rJson["conversion_rates"][key]["key"]}</td>
//             <td>${Math.round(rJson["conversion_rates"][key]["key"] * value)}</td>
//         </tr>
// `
// }
